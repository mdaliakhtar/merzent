...
$(function($){
	...
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'img/slider/a1.jpg'},
											{image : 'img/slider/a2.jpg'},
											{image : 'img/slider/a3.jpg'},
											{image : 'img/slider/a4.jpg'},
											{image : 'img/slider/a5.jpg'}
									]
...
// -----------------------------------------------------  GOOGLE MAP		
jQuery(document).ready(function(){ 
	var myLatlng = new google.maps.LatLng(13.064871, 80.175871);
	var myOptions = {
	  center: myLatlng,
	  zoom: 8,
